void getHeader() {
  ...
  webpage += "</style>\n";
  webpage += "</head>\n";
    webpage += "<body style=\"background-image: linear-gradient(to bottom,pink 0,#222 100%); height: -webkit-fill-available;\">\n";
      webpage += "<div class=\"container\">\n";
        webpage += "<div class\"container-fluid\">\n";
        
          webpage +="<div class=\"centered\">\n";
          webpage +="<h1 style=\"color:purple\" class=\"text-center\">" + mainHeading + "</h1>\n";
          webpage += "<h3 style=\"color:yellow\" class=\"text-center\">" + subHeading + "</h1>\n";
          webpage += "</div>\n";
          /*
